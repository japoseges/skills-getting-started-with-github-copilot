...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim workouts and friendly competitions at the school pool",
        "schedule": "Wednesdays and Fridays, 3:00 PM - 4:30 PM",
        "max_participants": 18,
        "participants": ["jason@mergington.edu", "sarah@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["david@mergington.edu", "zoe@mergington.edu"]
    },
    "Robotics Club": {
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["ian@mergington.edu", "nina@mergington.edu"]
    }
}
